...
s.source = {
  :http   => 'https://github.com/tasheercom/tasheer-podspecs/releases/download/v1.2.0/TasheerEnrollmentSDK-1.2.0.zip',
  :type   => 'zip',
  :sha256 => '448ec8b88cb13d0801630763dccb0e926c0bfeade4246ebad266f568c8f75ec8'
}
