...
s.source = {
  :http   => 'https://github.com/tasheercom/tasheer-podspecs/releases/download/v1.0.1/TasheerEnrollmentSDK-1.0.1.zip',
  :type   => 'zip',
  :sha256 => 'b575cf435dec50a0b38cf4918cb13e43432327c48947296b161debce9ac498e1'
}
